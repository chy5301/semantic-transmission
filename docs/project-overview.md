...
阶段二通过 structured-workflow 管理，共 27 个任务，全部完成：
...
| Phase 3：质量评估与文档重构 | 评估模块、文档体系 | ✅ 6/6 |
| Phase 4：CLI 正规化 | click 框架、`semantic-tx` 统一入口 | ✅ 4/4 |
| Phase 5：GUI 开发 | Gradio 可视化界面（`semantic-tx gui`） | ✅ 3/3 |
...
6. **CLI 统一入口**：`semantic-tx` 命令涵盖发送、接收、演示、检查、下载、GUI 启动
7. **Gradio 可视化界面**：`semantic-tx gui` 提供配置管理、发送端/接收端操作、一键端到端演示和质量评估
